...
filters = [
    ...
    CategoryFilter(
        operator=job_schema.job_skills.contains,
        param_name="job_skills_include",
        field_name="job_skills",
        description="Job skills that should be included.",
        options=job_categories.get("skills_list", []),
    ),
    CategoryFilter(
        operator=job_schema.job_skills.not_contains,
        param_name="job_skills_exclude",
        field_name="job_skills",
        description="Job skills that should be excluded.",
        options=job_categories.get("skills_list", []),
    ),
]
