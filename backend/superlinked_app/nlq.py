...
title_description = (
    ...
    "Look for explicit job titles like 'Data Scientist', 'Software Engineer', 'Data Analyst', etc.\n"
    ...
    "'data scientist', 'ml engineer', 'machine learning engineer' -> 'Data Scientist'; "
    "'data engineer', 'etl developer' -> 'Data Engineer'.\n"
    "If a job title is mentioned (even with 'jobs' suffix), extract it. For example:\n"
...
skills_description = (
    ...
    "Return as an array of strings, e.g., ['SQL', 'Python'] or null if none."
)
...
system_prompt = (
    ...
    "**OUTPUT FORMAT**\n"
    "All filter fields ending with '_include' or '_exclude' should be returned as arrays of strings or null. "
    "For example: 'job_categories_include': ['data_analyst'], 'states_exclude': null\n\n"
    ...
    "**'title' field**\n"
    "Extract specific job titles from the query. Look for explicit mentions like 'Data Scientist', 'Software Engineer', etc.\n"
    "Common dataset examples: 'Data Analyst', 'Software Engineer', 'Data Scientist', 'Data Engineer', "
    "'Senior Data Analyst', 'Machine Learning Engineer'.\n"
    "IMPORTANT: If the query contains a job title followed by 'jobs', 'positions', 'roles', etc., "
    "still extract the title. Examples:\n"
    "- 'Data Scientist jobs in Australia' -> title: 'Data Scientist'\n"
    "- 'Software Engineer positions with React' -> title: 'Software Engineer'\n"
    "- 'Data Analyst roles in New York' -> title: 'Data Analyst'\n"
    "If no specific title is mentioned, use empty string.\n\n"
    "**'location' field**\n"
    ...
    "Map variations: 'UK', 'Britain' -> 'United Kingdom'; 'US', 'USA', 'America' -> 'United States'. "
    "Return as an array of strings, e.g., ['United States'] or null if none.\n\n"
    ...
    "Return as an array of strings, e.g., ['San Francisco'] or null if none.\n\n"
    ...
    "Return as an array of strings or null if none.\n\n"
    "**'companies_include' field**\n"
    "When specific company names are mentioned, add them to this filter. "
    "Return as an array of strings, e.g., ['Google'] or null if none.\n\n"
    ...
    "Return as an array of strings, e.g., ['Associate'] or null if none.\n\n"
    "**'job_types_include' field**\n"
    "Options: 'Onsite', 'Hybrid', 'Remote'. "
    "Map variations appropriately. "
    "Return as an array of strings, e.g., ['Remote'] or null if none.\n\n"
    "**'salary' field**\n"
    ...
    "Return as an array of strings, e.g., ['data_analyst'] or null if none.\n\n"
    "**Weight Parameters**\n"
...
cv_system_prompt = (
    "Extract job search parameters from the provided CV/resume text. The CV describes a person's skills, experience, and background. "
    "Translate this into job search criteria that would find suitable job opportunities for this person.\n\n"
    "**OUTPUT FORMAT**\n"
    "All filter fields ending with '_include' or '_exclude' should be returned as arrays of strings or null.\n\n"
    "**GUIDELINES**\n"
    "- Extract skills, technologies, and competencies mentioned in the CV\n"
    "- Determine experience level based on years of experience and job titles\n"
    "- Look for preferred work arrangements (remote, onsite, etc.)\n"
    "- Extract location preferences if mentioned\n"
    "- Focus on technical skills for 'description' field\n"
    "- Use job titles from CV to inform 'title' field\n\n"
    "**'description' field**\n"
    "Create a normalized description of the candidate's technical skills and experience. "
    "Examples: 'Python programming, machine learning, data analysis', 'software development with Java and AWS', "
    "'data engineering with SQL and Spark'.\n\n"
    "**'title' field**\n"
    "Extract the most recent or primary job title from the CV. "
    "Examples: 'Data Scientist', 'Software Engineer', 'Data Analyst'.\n\n"
    "**'skills' field**\n"
    "List all technical and professional skills mentioned in the CV that match available skills.\n\n"
    "**'job_levels_include' field**\n"
    "Based on experience: 'Associate' for 0-3 years, 'Mid Senior' for 3+ years.\n\n"
    "**Other fields**\n"
    "Set location/country preferences if mentioned in CV, otherwise leave as null.\n"
    "Set job_types_include based on work preferences mentioned.\n\n"
    "**Weight Parameters**\n"
    "- description_weight: Default 0.9 (high priority for skill matching)\n"
    "- title_weight: Default 0.8\n"
    "- similar_description_weight: Default 0.9\n"
    "- similar_title_weight: Default 0.8\n"
)